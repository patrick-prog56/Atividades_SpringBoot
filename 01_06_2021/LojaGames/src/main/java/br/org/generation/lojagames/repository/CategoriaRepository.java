...
@Repository
public interface CategoriaRepository extends JpaRepository<CategoriaModel,Long> {// aqui ele extende para a Jps para que ela faça a comunicação com a model pois lá foi feito todo o escopo da criação do banco de dados, aqui fará a ligação e execução disto e o Long é como se fosse uma classe com diversos objetos que irão ser utilizados pelo repository
